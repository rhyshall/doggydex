// Rename the Schapendoes Gray coat document to Gray & White.
// Usage: node scripts/rename-schapendoes-gray-to-gray-white.js
...
const oldId = 'schapendoes__gray';
const newId = 'schapendoes__gray_white';
...
async function renameCoat() {
  ...
  await db.runTransaction(async (transaction) => {
    ...
    transaction.set(newRef, {
      ...
      img_filename: 'schapendoes_gray_white.jpg',
      img_two_filename: 'schapendoes_gray_white_two.jpg',
