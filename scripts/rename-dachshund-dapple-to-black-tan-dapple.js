...
// Usage: node scripts/rename-dachshund-dapple-to-black-tan-dapple.js
...
async function renameCoat() {
  const oldId = 'dachshund__dapple';
  const newId = 'dachshund__black_tan_dapple';
