// Add the Chihuahua Red coat document in Firestore.
// Usage: node scripts/add-chihuahua-red-coat.js
...
async function addCoat() {
  ...
  await db.runTransaction(async (transaction) => {
    ...
    transaction.set(docRef, {
      ...
      img_filename: 'chihuahua_red.jpg',
      img_two_filename: 'chihuahua_red_two.jpg',
...
addCoat().catch((error) => {
  console.error('Error adding Chihuahua Red coat:', error);
  process.exit(1);
});
