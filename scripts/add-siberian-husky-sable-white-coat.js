// Add the Siberian Husky Sable & White coat document in Firestore.
// Usage: node scripts/add-siberian-husky-sable-white-coat.js
...
const docId = 'siberian_husky__sable_white';
...
async function addCoat() {
  ...
  await db.runTransaction(async (transaction) => {
    ...
    transaction.set(docRef, {
      ...
      color_name: 'Sable & White',
      image_exists: false,
      image_two_exists: false,
      img_filename: 'siberian_husky_sable_white.jpg',
      img_two_filename: 'siberian_husky_sable_white_two.jpg',
...
addCoat().catch((error) => {
  console.error('Error adding Siberian Husky Sable & White coat:', error);
  process.exit(1);
});
