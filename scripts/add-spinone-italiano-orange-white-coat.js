// Add the Spinone Italiano Orange & White coat document in Firestore.
// Usage: node scripts/add-spinone-italiano-orange-white-coat.js
...
const docId = 'spinone_italiano__orange_white';
...
async function addCoat() {
  ...
  await db.runTransaction(async (transaction) => {
    ...
    transaction.set(docRef, {
      coat_id: maxCoatId + 1,
      coat_name: docId,
      breed_id: 'spinone_italiano',
      color_name: 'Orange & White',
      image_exists: false,
      image_two_exists: false,
      img_filename: 'spinone_italiano_orange_white.jpg',
      img_two_filename: 'spinone_italiano_orange_white_two.jpg',
...
addCoat().catch((error) => {
  console.error('Error adding Spinone Italiano Orange & White coat:', error);
  process.exit(1);
});
