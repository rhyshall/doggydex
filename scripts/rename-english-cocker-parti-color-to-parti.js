// Rename the English Cocker Spaniel Parti Color coat document to Parti.
// Usage: node scripts/rename-english-cocker-parti-color-to-parti.js
...
const oldDocumentId = 'cocker_spaniel_english__parti_color';
const newDocumentId = 'cocker_spaniel_english__parti';
...
async function renameCoatDocument() {
  ...
  await db.runTransaction(async (transaction) => {
    ...
    transaction.set(newRef, {
      ...
      color_name: 'Parti',
      breed_id: 'cocker_spaniel_english',
      img_filename: 'cocker_spaniel_english_parti.jpg',
      img_two_filename: 'cocker_spaniel_english_parti_two.jpg',
