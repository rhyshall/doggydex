// Rename the Schapendoes White coat document to Gray & Black.
// Usage: node scripts/rename-schapendoes-white-to-gray-black.js
...
const oldId = 'schapendoes__white';
const newId = 'schapendoes__gray_black';
...
async function renameCoat() {
  ...
  await db.runTransaction(async (transaction) => {
    ...
    transaction.set(newRef, {
      ...sourceData,
      coat_name: newId,
      color_name: 'Gray & Black',
      img_filename: 'schapendoes_gray_black.jpg',
      img_two_filename: 'schapendoes_gray_black_two.jpg',
