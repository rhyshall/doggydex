// Rename and normalize the Whippet Fawn & White coat document in Firestore.
// Usage: node scripts/rename-whippet-fawn-white-coat-doc.js
...
const oldId = 'whippet__fawn';
const newId = 'whippet__fawn_white';
...
async function renameCoatDocument() {
  ...
  await db.runTransaction(async (transaction) => {
    ...
    transaction.set(newRef, {
      ...oldSnapshot.data(),
      coat_name: newId,
      color_name: 'Fawn & White',
      img_filename: 'whippet_fawn_white.jpg',
      img_two_filename: 'whippet_fawn_white_two.jpg',
