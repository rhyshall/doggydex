// Rename the Spinone Italiano Liver & White coat document to White.
// Usage: node scripts/rename-spinone-italiano-liver-white-to-white.js
...
const oldId = 'spinone_italiano__liver_white';
const newId = 'spinone_italiano__white';
...
async function renameCoat() {
  ...
  await db.runTransaction(async (transaction) => {
    ...
    transaction.set(newRef, {
      ...
      coat_name: newId,
      color_name: 'White',
      img_filename: 'spinone_italiano_white.jpg',
      img_two_filename: 'spinone_italiano_white_two.jpg',
